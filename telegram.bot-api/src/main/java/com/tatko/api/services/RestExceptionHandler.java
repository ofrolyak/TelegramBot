...
//        details.add(ex.getLocalizedMessage());
     ...
     *         of {@code HttpStatus.UNAUTHORIZED}
     */
    @ExceptionHandler({AuthenticationException.class})
    public ResponseEntity<GeneralErrorResultApiResponse> handleAll(
            final AuthenticationException ex, final WebRequest request) {
        log.debug("AuthenticationException exception", ex);
//        List<String> details = new ArrayList<>();
//        details.add(ex.getLocalizedMessage());
        GeneralErrorResultApiResponse generalErrorResultApiResponse
                = new GeneralErrorResultApiResponse();
     ...
     * a {@code GeneralErrorResultApiResponse}
     *         with error details and a status
     *         of {@code HttpStatus.FORBIDDEN}
     */
    @ExceptionHandler({AccessDeniedException.class})
    public ResponseEntity<GeneralErrorResultApiResponse> handleAll(
            final AccessDeniedException ex, final WebRequest request) {
        log.debug("AccessDeniedException exception", ex);
//        List<String> details = new ArrayList<>();
//        details.add(ex.getLocalizedMessage());
        GeneralErrorResultApiResponse generalErrorResultApiResponse
                = new GeneralErrorResultApiResponse();
     ...
     * Constructs a standardized error response based
