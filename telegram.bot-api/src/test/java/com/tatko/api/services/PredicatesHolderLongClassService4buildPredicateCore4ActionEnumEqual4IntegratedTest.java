...
@Slf4j
class PredicatesHolderLongClassService4buildPredicateCore4ActionEnumEqual4IntegratedTest
    ...
    protected void setUp() {
        super.setUp();
        ((FilterLongApiObject) filterAdApiRequest.getId().getValue().getValue()).setAction(FilterLongApiObject.ActionEnum.EQUAL);
    }
